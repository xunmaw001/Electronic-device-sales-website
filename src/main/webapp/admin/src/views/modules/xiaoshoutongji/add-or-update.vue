<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="销售数量" prop="xiaoshoushuliang">
          <el-input v-model="ruleForm.xiaoshoushuliang" 
              placeholder="销售数量" clearable  :readonly="ro.xiaoshoushuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="销售数量" prop="xiaoshoushuliang">
              <el-input v-model="ruleForm.xiaoshoushuliang" 
