      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商品价格" prop="shangpinjiage">
          <el-input v-model="ruleForm.shangpinjiage" 
              placeholder="商品价格" clearable  :readonly="ro.shangpinjiage"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商品价格" prop="shangpinjiage">
              <el-input v-model="ruleForm.shangpinjiage" 
                placeholder="商品价格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="商品简介" prop="shangpinjianjie">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shangpinjianjie" label="商品简介" prop="shangpinjianjie">
                    <span>{{ruleForm.shangpinjianjie}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jifenshangcheng/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jifenshangchengCrossAddOrUpdateFlag = false;
                  this.parent.search();
